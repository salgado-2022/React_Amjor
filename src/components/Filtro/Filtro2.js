    ...
    <div className="row">
        <div className="col-md-12 mb-5">
            <div className="float-md-left mb-4">
                <h2 className="text-black h5">¡Mira todos nuestros productos!</h2>
            </div>
            <div className="d-flex">
                <div className="dropdown mr-1 ml-md-auto">
                    <button style={{ textTransform: 'none'}} type="button" className="btn btn-secondary btn-sm dropdown-toggle" id="dropdownMenuOffset" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
