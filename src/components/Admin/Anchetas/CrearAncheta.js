        ...
        <div>
            <form onSubmit={handleSubmit} onReset={handleReset} encType="multipart/form-data">
                ...
                <div className="form-group">
                    ...
                    <label htmlFor="image" style={{ color: "black", height: "50px", width: "180px", backgroundColor: "#feeb75", borderRadius: "8px", fontSize: "16px", display: "flex", justifyContent: "center", alignItems: "center" }}>
                ...
                <div className="form-check" style={{ marginBottom: '7px' }}>
                    ...
                    <label className="form-check-label" htmlFor="estadoAncheta">Disponible</label>
                </div>
